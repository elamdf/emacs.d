...
#+RESULTS:
| ghostel-comint-global-mode | ghostel-compile-global-mode | org-persist-load-all | tramp-register-archive-autoload-file-name-handler | magit-maybe-define-global-key-bindings | table--make-cell-map | magit-startup-asserts | magit-version | forge-startup-asserts |

* Codex
#+begin_src emacs-lisp

  (add-to-list 'load-path
               (expand-file-name "plugins/codex" user-emacs-directory))
  (use-package codex
    :ensure nil
    :demand t
    :bind-keymap ("C-c x" . codex-command-map)
    :custom (codex-terminal-backend 'ghostel))

#+end_src

#+RESULTS:
: #[nil ((use-package-autoload-keymap 'codex-command-map 'codex nil)) nil nil nil nil]
