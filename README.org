    ...
    ;; > CR elamdf for elamdf: make C-c ! n/p only go to errors
        (use-package flycheck
          ...
          (add-to-list 'display-buffer-alist
                       '(elamdf/flycheck-error-list-display-p
...
#+RESULTS:
| #[nil ((prettify-symbols-mode)) nil] | rust-maybe-initialize-buffer-project | eglot-ensure | doom-modeline-env-setup-rust |
...
#+BEGIN_SRC emacs-lisp
  ...
  (dolist (hook '(markdown-mode-hook org-mode-hook c-mode-hook rust-mode-hook rust-conf-mode))
    ...
    (add-hook 'magit-status-headers-hook #'bismuth-magit-insert-actionables t)
#+END_SRC
