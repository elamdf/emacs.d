...
#+begin_src emacs-lisp
  ...
  (use-package consult
    ...
    :init
    ;; Keep everything in the minibuffer until *you* ask to preview:
    ;;   - nil = no automatic preview
    ;;   - "M-." = press M-. to preview current candidate
    (setq consult-preview-key "M-."))
  ;; If you want zero preview ever, use:
  ...
  (global-set-key (kbd "C-x B")   #'consult-project-buffer)
    ...
    ;;; --- Files: pick ONE of these approaches ---

  ;; Option A: Keep classic find-file (already minibuffer via Vertico)
  ;; (global-set-key (kbd "C-x C-f") #'find-file)

  ;; Option B: Replace with a fast file finder (fd recommended)
  ;; Requires 'fd' in PATH. Falls back to 'find' with consult-find.
  (when (executable-find "fd")
    (global-set-key (kbd "C-x C-f") #'consult-fd))
  ;; If you prefer POSIX find:
  ...
  (global-set-key (kbd "C-c s")   #'consult-ripgrep)       ; search project
