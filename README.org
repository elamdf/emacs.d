...
#+begin_src emacs-lisp
  ...
  :bind (("C-x a t" . codex-cli-toggle)
         ("C-x a s" . codex-cli-start)
         ("C-x a q" . codex-cli-stop)
         ("C-x a Q" . codex-cli-stop-all)
         ("C-x a p" . codex-cli-send-prompt)
         ("C-x a r" . codex-cli-send-region)
         ("C-x a f" . codex-cli-send-file)
         ;; Show-all layout + paging
         ("C-x a a" . codex-cli-toggle-all)
         ;; ("C-x a n" . codex-cli-toggle-all-next-page)
         ;; ("C-x b" . codex-cli-toggle-all-prev-page)
         )
  :init
